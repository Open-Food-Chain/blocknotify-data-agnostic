...
p2p_port = os.getenv('BATCH_SMARTCHAIN_NODE_P2P_PORT')
...
#print("accessing on url: " + str(rpc_port))
print("accessing on port: " + str(rpc_port))

conn = rpc_connect(user_name, password, rpc_port)
